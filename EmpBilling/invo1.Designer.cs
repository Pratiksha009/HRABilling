    ...
    public partial class invo : global::System.Data.DataSet {
        ...
        public partial class InvoiceDataTable : global::System.Data.TypedTableBase<InvoiceRow> {
            ...
            private void InitClass() {
                ...
                this.columnservicetaxtotal = new global::System.Data.DataColumn("servicetaxtotal", typeof(int), null, global::System.Data.MappingType.Element);
        ...
        public partial class InvoiceRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public int servicetaxtotal {
                get {
                    try {
                        return ((int)(this[this.tableInvoice.servicetaxtotalColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace EmpBilling.invoTableAdapters {
    ...
    public partial class InvoiceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [DtdcBilling].[Invoice] WHERE (([IN_Id] = @Original_IN_Id))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [DtdcBilling].[Invoice] ([invoiceno], [invoicedate], [periodfrom], [periodto], [total], [fullsurchargetax], [fullsurchargetaxtotal], [servicetax], [servicetaxtotal], [othercharge], [netamount], [Customer_Id], [fid], [annyear], [paid], [status], [discount], [discountper], [discountamount], [servicecharges], [Royalty_charges], [Docket_charges], [Tempdatefrom], [TempdateTo], [tempInvoicedate], [Address]) VALUES (@invoiceno, @invoicedate, @periodfrom, @periodto, @total, @fullsurchargetax, @fullsurchargetaxtotal, @servicetax, @servicetaxtotal, @othercharge, @netamount, @Customer_Id, @fid, @annyear, @paid, @status, @discount, @discountper, @discountamount, @servicecharges, @Royalty_charges, @Docket_charges, @Tempdatefrom, @TempdateTo, @tempInvoicedate, @Address)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@servicetaxtotal", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "servicetaxtotal", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@servicetaxtotal", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "servicetaxtotal", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT IN_Id, invoiceno, invoicedate, periodfrom, periodto, total, fullsurchargetax, fullsurchargetaxtotal, servicetax, servicetaxtotal, othercharge, netamount, Customer_Id, fid, annyear, paid, status, discount, discountper, discountamount, servicecharges, Royalty_charges, Docket_charges, Tempdatefrom, TempdateTo, tempInvoicedate, Address FROM DtdcBilling.Invoice";
        ...
        public virtual int Insert(
                    ...
                    global::System.Nullable<int> servicetaxtotal, 
            ...
            if ((servicetaxtotal.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[8].Value = ((int)(servicetaxtotal.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            if ((servicetaxtotal.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(servicetaxtotal.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[26].Value = ((int)(Original_IN_Id));
